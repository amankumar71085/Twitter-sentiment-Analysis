...
Text Preprocessing: Custom regex cleaning to strip URLs, @mentions, hashtags, and punctuation, followed by lowercase normalization.
Vectorization: TF-IDF (Term Frequency-Inverse Document Frequency) limited to the top 10,000 most common features.
Classification: Logistic Regression model (max_iter=1000).
Performance
Testing Split: 20%
